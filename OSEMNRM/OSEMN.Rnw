...
#Line chart
ggplot(data=df, aes(x=langs, y=repos, group=1)) +geom_line(colour="coral1",size=1)+geom_point(size=3, fill="white")+expand_limits(y=0)+scale_shape_manual(values=c(22,21))
